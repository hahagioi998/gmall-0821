...
public class AttrGroupController {
    ...
    public ResponseVo<List<GroupVo>> queryGroupWithAttrValuesBy(
        ...
        List<GroupVo> groupVos = attrGroupService.queryGroupWithAttrValuesBy(cid, spuId, skuId);
    ...
    public ResponseVo<List<AttrGroupEntity>> queryAttrGroupsByCatId(@PathVariable("catId")Long catId){
        List<AttrGroupEntity> attrGroupEntities = attrGroupService.queryAttrGroupsByCatId(catId);
